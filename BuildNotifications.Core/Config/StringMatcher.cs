...
/// <summary>
/// Implements search pattern to match strings. Supports wildcards * and explicit match is implied by
/// default.
...
public class StringMatcher
{
    ...
    private bool IsNonSpecialCharacter(string split) => split.Length != 1 || !SpecialCharacters.Contains(split[0]);
