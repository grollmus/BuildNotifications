...
internal class TypeMatcher : ITypeMatcher
{
    ...
    private sealed class TypeName
    {
        ...
        public override bool Equals(object? obj) => ReferenceEquals(this, obj) || (obj is TypeName other && Equals(other));

        public override int GetHashCode()
        {
            unchecked
            {
                return (_assemblyName.GetHashCode(StringComparison.InvariantCulture) * 397)
                       ^ _fullTypeName.GetHashCode(StringComparison.InvariantCulture);
            }
        }
