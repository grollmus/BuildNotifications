...
internal sealed class CacheKey
{
    ...
    public bool IsProvider(string providerId) => _providerId == providerId;

    private bool EqualsOtherCacheKey(CacheKey other) => string.Equals(_providerId, other._providerId, StringComparison.InvariantCulture)
