...
internal static class DpApi
{
    ...
    public static string Decrypt(string cipherText) => Decrypt(DefaultKeyType, cipherText);
    ...
    public static string Encrypt(string plainText) => Encrypt(DefaultKeyType, plainText);
