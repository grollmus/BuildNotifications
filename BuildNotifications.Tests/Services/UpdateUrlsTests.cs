...
namespace BuildNotifications.Tests.Services
{
    ...
    {
        public static TheoryData<Uri, string> BaseAddressTestCases =>
        ...
        public static TheoryData<string, string, string> DownloadFileTestCases =>
        ...
        public static TheoryData<Uri, string> RelativeFileDownloadTestCases =>
            new TheoryData<Uri, string>
            {
