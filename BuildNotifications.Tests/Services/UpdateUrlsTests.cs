...
{
    public static TheoryData<Uri, string> BaseAddressTestCases => new()
    {
        { new Uri("http://example.com"), "http://example.com/" },
        { new Uri("https://example.com/file.name"), "https://example.com/" }
    };

    public static TheoryData<string, string, string> DownloadFileTestCases => new()
    {
    ...
    public static TheoryData<Uri, string> RelativeFileDownloadTestCases => new()
    {
