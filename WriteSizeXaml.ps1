...
[void]$sb.AppendLine("")
[void]$sb.AppendLine("    <Thickness Left=`"{StaticResource BlockOneAndQuarter}`" Right=`"{StaticResource NegativeBlockHalf}`" Top=`"0`" Bottom=`"0`" x:Key=`"BlockOneAndQuarterLeftAndNegativeBlockHalfRight`"/>")
