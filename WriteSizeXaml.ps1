...
[void]$sb.AppendLine("")
[void]$sb.AppendLine("    <Thickness Left=`"{StaticResource BlockThreeQuarters}`" Right=`"{StaticResource NegativeBlockThreeQuarters}`" Top=`"0`" Bottom=`"0`" x:Key=`"BlockThreeQuartersLeftAndNegativeRight`"/>")
[void]$sb.AppendLine("    <Thickness Left=`"{StaticResource BlockThreeQuarters}`" Right=`"{StaticResource BlockThreeQuarters}`" Top=`"0`" Bottom=`"0`" x:Key=`"BlockThreeQuartersLeftAndRight`"/>")
