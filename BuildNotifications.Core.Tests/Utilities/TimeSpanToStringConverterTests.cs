...
#nullable enable
    ...
    private static DateTime BaseDateTime { get; } = new(2000, 1, 1, 0, 0, 0);
    ...
    private static string GetTimeString(string textId) => StringLocalizer.Instance.GetText(textId, TestCulture);
