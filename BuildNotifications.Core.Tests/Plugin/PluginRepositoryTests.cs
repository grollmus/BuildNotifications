...
public class PluginRepositoryTests
{
    ...
    public void BuildShouldContainAllBuildPlugins()
    {
        ...
        var notificationProcessors = Array.Empty<INotificationProcessor>();
    ...
    public void FindBuildPluginShouldFindPluginWhenExisting()
    {
        ...
        var sut = new PluginRepository(buildPlugins, Array.Empty<ISourceControlPlugin>(), Array.Empty<INotificationProcessor>(), typeMatcher);
    ...
    {
        // Arrange
        var sut = new PluginRepository(Array.Empty<IBuildPlugin>(), Array.Empty<ISourceControlPlugin>(), Array.Empty<INotificationProcessor>(), Substitute.For<ITypeMatcher>());
    ...
    {
        // Arrange
        var sut = new PluginRepository(Array.Empty<IBuildPlugin>(), Array.Empty<ISourceControlPlugin>(), Array.Empty<INotificationProcessor>(), new TypeMatcher());
    ...
    public void FindSourceControlPluginShouldFindPluginWhenExisting()
    {
        ...
        var sut = new PluginRepository(Array.Empty<IBuildPlugin>(), sourceControlPlugins, Array.Empty<INotificationProcessor>(), typeMatcher);
