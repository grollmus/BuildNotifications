...
public abstract class BuildTreeNodeViewModel : BaseViewModel
{
    ...
    protected virtual DateTime CalculateQueueTime() => _queuedTime;
    ...
    {
        if (HandleChildEventSubscriptions(e))
            return;
    ...
    private bool HandleChildEventSubscriptions(NotifyCollectionChangedEventArgs e)
    {
        switch (e.Action)
        {
