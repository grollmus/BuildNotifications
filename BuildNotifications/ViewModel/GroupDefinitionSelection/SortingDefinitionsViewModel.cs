...
public class SortingDefinitionsViewModel : BaseViewModel
{
    public SortingDefinitionsViewModel(GroupDefinition forGroupDefinition)
    {
        ...
        {
            new(forGroupDefinition, SortingDefinition.AlphabeticalDescending),
            new(forGroupDefinition, SortingDefinition.AlphabeticalAscending),
            new(forGroupDefinition, SortingDefinition.StatusDescending),
            new(forGroupDefinition, SortingDefinition.DateDescending)
        };
