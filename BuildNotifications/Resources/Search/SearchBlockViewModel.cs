...
internal class SearchBlockViewModel : BaseViewModel
{
    ...
    public ObservableCollection<SearchBlockExampleViewModel> Examples { get; } = new();
    ...
    public RemoveTrackingObservableCollection<SearchSuggestionViewModel> Suggestions { get; } = new(TimeSpan.FromMilliseconds(100));
