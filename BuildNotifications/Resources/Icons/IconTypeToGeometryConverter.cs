...
internal class IconTypeToGeometryConverter : IValueConverter
{
    ...
    public static IconTypeToGeometryConverter Instance { get; } = new();
    ...
    private static IEnumerable<IconType> SupportedIcons
    {
        get
        {
            ...
            yield return IconType.PullRequest;
        }
    }
    ...
    private static Geometry IconTypeToGeometry(IconType type)
    {
        switch (type)
        {
            ...
            case IconType.PullRequest:
                return Geometry.Parse("F1 M12,12z M0,0z M6.55,3.25L8.7,5.45 8.7,3.25 5.45,0 2.2,3.25 2.2,5.45 4.35,3.25 4.35,12 6.55,12 6.55,8.7Q7.7,9.8,9.8,9.8L9.8,7.6Q8.7,7.6 7.7,7 6.55,6.4 6.55,5.45L6.55,3.25z");
            default:
