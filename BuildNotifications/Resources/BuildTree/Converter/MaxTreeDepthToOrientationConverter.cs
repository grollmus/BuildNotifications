...
/// <summary>
/// With zero, one and three levels of grouping the first level looks better when displayed
/// horizontally.
/// </summary>
internal class MaxTreeDepthToOrientationConverter : IValueConverter
{
    ...
    public static MaxTreeDepthToOrientationConverter Instance { get; } = new();
