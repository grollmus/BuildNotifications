...
public partial class App
{
    ...
    /// <summary>
    /// Don't use LogTo. here, as the weaving would cause NLog to fail to initialize, as the line above
    /// sets up a log target
    /// </summary>
    ...
    /// <summary>
    /// BN may be started from a different path or by URI scheme which will result in the working directory
    /// being somewhere
